          ...
          <div className="p-6 md:p-8 pb-20">
            ...
            <div className="mt-6 flex items-center justify-center">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-md bg-[#1a1a1a] text-white px-4 py-2 font-medium hover:bg-red-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
              >
