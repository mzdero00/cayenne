    ...
    <>
      ...
      <div className="pt-20 md:pt-24">
        ...
        <section className="relative h-[70vh] w-full font-jomolhari">
          ...
          {/* soft overlay; no pointer events so clicks go through */}
          <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/10 to-transparent pointer-events-none" />

          {/* Glass search panel (padding set to avoid navbar overlap on all screens) */}
          <div className="absolute inset-0 flex items-start justify-center px-4 pt-8 md:pt-12 lg:pt-16">
      ...
      {/* RESULTS — scroll margin ensures anchor isn't hidden under the fixed navbar */}
      <section
        id="results"
